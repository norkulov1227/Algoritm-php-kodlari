<?php
$admin = "972766279";
$token = '1587754744:AAEBk1Dlsdn26OxqO-smLN1JNA6E5yuTdLI';
$mybot="SinovTestiRoBot";
...
if($text=="/start@Qr_Kod_Tayyorlash_Bot" or $text=="/start" or mb_stripos($text,"qwertyuiop")!==false){
if($ism==false){
file_put_contents("step/$cid.txt","ism");
        bot('SendMessage',[
   'chat_id'=>$cid,
        'text'=>"<b>Ismingizni kiriting!!!
misol: Uluģbek Uralov</b>
...
👨🏻‍💻 Yaratuvchi: <a href='tg://user?id=1973951719'>Uralov</a>
👨🏻‍🏫 Oʻqituvchi : <a href='tg://user?id=1973951719'>Uralov</a>
...
👨🏻‍💻 Yaratuvchi: <a href='tg://user?id=1973951719'>Uralov</a>
👨🏻‍🏫 Oʻqituvchi : <a href='tg://user?id=1973951719'>Uralov</a>
🤖Hostingsiz bot yaratish: @SinovTestiRoBot
<b>🖊️ Ismingizni uzgartirish uchun</b>
/ismuzgartirish <b>ni bosing.</b>
...
$tex=file_get_contents("step/$id[0]/$ex[1].txt");
 $ok1=bot('sendPhoto',[
    'chat_id'=>$id[0],
'photo'=>"https://u1077.xvest.ru/OnineApi/index.php?ism=$id[1]&fan=$fan&admin=$ad[1]&soni=$id[2]&orin=1",
...
$tex=file_get_contents("step/$id[0]/$ex[1].txt");
 $ok2=bot('sendPhoto',[
    'chat_id'=>$id[0],
'photo'=>"https://u1077.xvest.ru/OnineApi/index1.php?ism=$id[1]&fan=$fan&admin=$ad[1]&soni=$id[2]&orin=2",
'caption'=>"<b>Hurmatli $id[1] $ex[1] kodli test yakunlandi</b>
...
$tex=file_get_contents("step/$id[0]/$ex[1].txt");
 $ok3=bot('sendPhoto',[
    'chat_id'=>$id[0],
'photo'=>"https://u1077.xvest.ru/OnineApi/index3.php?ism=$id[1]&fan=$fan&admin=$ad[1]&soni=$id[2]&orin=3",
'caption'=>"<b>Hurmatli $id[1] $ex[1] kodli test yakunlandi</b>
...
$id=explode("*",$ismi);
$tex=file_get_contents("step/$id[0]/$ex[1].txt");
$ra=["https://uzliderboy.platinumhost.uz/image/index.php?ism=$id[1]&fan=$fan&admin=$ad[1]","https://uzliderboy.platinumhost.uz/image1/index.php?ism=$id[1]&fan=$fan&admin=$ad[1]"];
$rand = array_rand($ra);
$rasm = "$ra[$rand]";
 $ok4=bot('sendPhoto',[
    'chat_id'=>$id[0],
...
<b><u>⏳ $vaqt | 📆 $sana </u></b>",
    ...
    'reply_markup'=>[
            'inline_keyboard'=>[
 [['text'=>"Testga javob berish!",'url'=>"https://t.me/$bot?start=qwertyuiop_UzLiderBoy"]],
        ]],
        ]
        ])
]); 
